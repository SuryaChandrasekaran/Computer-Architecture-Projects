...
public class graphHitWayAssociative4LineSize8 extends ApplicationFrame {

   public graphHitWayAssociative4LineSize8( String applicationTitle , String chartTitle ) {
   ...
   public static void main( String[ ] args ) {
	   graphHitWayAssociative4LineSize8 chart = new graphHitWayAssociative4LineSize8(
