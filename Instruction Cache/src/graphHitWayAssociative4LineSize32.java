...
public class graphHitWayAssociative4LineSize32 extends ApplicationFrame {

   public graphHitWayAssociative4LineSize32( String applicationTitle , String chartTitle ) {
   ...
   public static void main( String[ ] args ) {
	   graphHitWayAssociative4LineSize32 chart = new graphHitWayAssociative4LineSize32(
