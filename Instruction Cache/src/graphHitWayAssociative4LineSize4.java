...
public class graphHitWayAssociative4LineSize4 extends ApplicationFrame {

   public graphHitWayAssociative4LineSize4( String applicationTitle , String chartTitle ) {
   ...
   public static void main( String[ ] args ) {
	   graphHitWayAssociative4LineSize4 chart = new graphHitWayAssociative4LineSize4(
