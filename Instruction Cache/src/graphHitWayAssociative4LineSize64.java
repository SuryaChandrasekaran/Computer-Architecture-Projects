...
public class graphHitWayAssociative4LineSize64 extends ApplicationFrame {

   public graphHitWayAssociative4LineSize64( String applicationTitle , String chartTitle ) {
   ...
   public static void main( String[ ] args ) {
	   graphHitWayAssociative4LineSize64 chart = new graphHitWayAssociative4LineSize64(
