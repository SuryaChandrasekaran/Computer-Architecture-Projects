...
public class graphHitWayAssociative4LineSize16 extends ApplicationFrame {

   public graphHitWayAssociative4LineSize16( String applicationTitle , String chartTitle ) {
   ...
   public static void main( String[ ] args ) {
	   graphHitWayAssociative4LineSize16 chart = new graphHitWayAssociative4LineSize16(
